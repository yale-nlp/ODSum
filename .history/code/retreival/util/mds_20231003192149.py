...
# chagne here for different dataset

# if choosing the Meeting setting
path = "../../data/Meeting/raw"
dataset = load_dataset('json', data_files={'train': path + '/train.jsonl', 'test': path + '/test.jsonl', 'dev': path + '/dev.jsonl'})

# if choosing the Wikipedia setting
